...
namespace SqlViewer.View
{
    public partial class MainForm : Form
    {
        ...
        private void ExecuteQuery()
        {
            ...
            string message = RepositoryFactory.GetRepository().ExecuteCommand(query);

            List<List<TableForShowing>> data = RepositoryFactory.GetRepository().ReadData(query);
            ...
            if (data != null && data.Count != 0)
            {
                ...
                {
                    tbResults.Text += data[0][j].columnName + '\t';
                }
                ...
                for (int i = 0; i < data.Count; i++)
                {
                    ...
                    {
                        tbResults.Text += data[i][j].columnValue + '\t';
                    }
                    tbResults.Text += Environment.NewLine;
                }
            }
